sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.cliente.controller.Page1", {
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						oModel = this.getView().getModel();
						var oNewBindingContext = oModel.createEntry("SolicitudSet", {
		...
		formatIconVisibilityFromCriticality: function(sCriticality) {
			var bIsVisible = false;
			if (sCriticality === "Negative" || sCriticality === "Critical" || sCriticality === "Positive") {
				bIsVisible = true;
			}
			return bIsVisible;
		...
		formatFractionVisibilityFromCriticality: function(sCriticality) {
			var bIsVisible = true;
			if (sCriticality === "Negative" || sCriticality === "Critical" || sCriticality === "Positive") {
				bIsVisible = false;
			}
