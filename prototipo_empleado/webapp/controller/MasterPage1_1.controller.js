sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prototypeEmployee.controller.MasterPage1_1", {
		...
		createFiltersAndSorters: function() {
			...
			aPropertyFilters.push(new sap.ui.model.Filter("Estado", "EQ", "En revision"));
		...
		onInit: function() {
			...
			this.oRouter.getTarget("MasterPage1_1").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
